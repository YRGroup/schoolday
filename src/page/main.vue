  ...
  <div class="index">
    ...
    <div class="section section3">
      <div class="card">
        ...
        <p @click="$router.push('/s/gjxx')"><span class="sLink">郑州航空港育人国际学校</span></p>
        <p>心智合一，博雅致远</p>
        </br></br>
        ...
        <p @click="$router.push('/s/nzzx')"><span class="sLink">郑州外国语女子中学</span></p>
        <p>优秀优雅，秀外慧中</p>
        </br></br>
        ...
        <p @click="$router.push('/s/gjzx')"><span class="sLink">郑州航空港区育人高级中学</span></p>
        <p>勇于优秀 · 敢于担当</p>
        </br></br>
        ...
        <p @click="$router.push('/s/xcyr')"><span class="sLink">襄城育人国际学校</span></p>
        <p>不鸣则已，一鸣惊人</p>
        </br></br>
        ...
        <p @click="$router.push('/s/baby')"><span class="sLink">e-BABY精致早教</span></p>
        <p>因为爱，懂宝贝才能更爱宝贝。</p>
        </br></br>
        ...
        <p @click="$router.push('/s/ayst')"><span class="sLink">爱因斯坦国际幼儿园</span></p>
        <p>国际化 · 优质化 · 特色化</p>
        </br></br>
      </div>
    </div>
    ...
    <div class="xiaozhang_popup" v-show="show_xiaozhang_popup">
      ...
      <div class="container">
        ...
        <div class="hr"></div>
        <div class="body">
          <p v-for="p in xiaozhang_popup_data.info">{{p}}</p>
        </div>
      </div>
    </div>
